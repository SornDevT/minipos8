...
export default {
    ...
    data() {
        return {
            check_login:false,
            img: location.origin.href+"/assets/img/avatars/1.png"
        };
    },
